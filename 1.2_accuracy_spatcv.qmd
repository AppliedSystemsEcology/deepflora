...
![Comparing presence accuracy from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/zero_one_accuracy.png)

### Precision score

**Precision** Measures how many species predicted to be present were actually present.

![Comparing precision score from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/precision_score.png)

### Recall score

**Recall** Measures how many of the true species present are predicted as present.

![Comparing recall score from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/recall_score.png)
...
![Comparing F1 score from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/f1_score.png)
...
![Comparing ROC area under curve from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/ROC_AUC.png)

### Area under curve \[PRC\] -- uncalibrated

**AUC PRC** Average area under the precision-recall curve averaged across species

![Comparing PRC area under curve from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/PRC_AUC.png)
...
![Comparing calibrated ROC area under curve from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/calibrated_ROC_AUC.png)

#### Calibrated AUC \[PRC\]

![Comparing calibrated PRC area under curve from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/calibrated_PRC_AUC.png)
...
![Comparing top 1 from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/species_top1.png)

### Species top 5

![Comparing top 5 from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/species_top5.png)

### Species top 30

![Comparing top 30 from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/species_top30.png)

### Species top 100

![Comparing top 100 from spatial cross validation for Pennsylvania (left) and New York (right)](plots/accuracy-metrics/spatcv/species_top100.png)
